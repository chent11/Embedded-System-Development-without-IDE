...
CLANG_TIDY_ERROR := *,-clang-diagnostic-unused-function,-cppcoreguidelines-avoid-magic-numbers,-readability-magic-numbers,-bugprone-dynamic-static-initializers,-clang-diagnostic-unused-parameter
check-clang-tidy:
