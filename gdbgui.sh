...
gdbgui -g ~/Projects/C/Embedded/toolchains/gcc-arm-none-eabi-9-2020-q2-update/bin/arm-none-eabi-gdb --project ./ --args "$1 -ex \"target remote localhost:2331\" -ex \"monitor reset\" -ex \"load\" -ex \"b main\" -ex \"c\""
